...
A set of initial lab configs for this post that will appear on [Tech Snippets](https://sipart.github.io/) in the future (to include detail on using EVE-NG on the Google Compute Platform as well!)
...
* Initial folder holds and configs for the devices and also a export from EVE-NG of the initial setup (upto page 15 of the book)
